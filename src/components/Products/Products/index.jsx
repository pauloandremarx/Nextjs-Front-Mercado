...
export default function Product( props ) {
    ...
    function addToCart(props, quantity, valor) {
        ...
        const product = {
            ...
            tax : valor,
            quantity: quantity,
            total: (props.valor * quantity) + (valor * quantity)
        };

        // Adicione o produto ao array de produtos do carrinho
        cartItems.push(product);

        // Atualize o localStorage com o array de produtos atualizado
